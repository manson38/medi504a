...
experienced by two groups. When comparing two *proportions*, we can use one of the two methods above,
...
jiang_live_birth_final %>%
  ...
  labs(
    title = "The Average Proportion of Live Birth Successes in Two Progesterone Supplementation Method\nGroups for those Undergoing Frozen-thawed Embryo Transfer During In-vitro Fertilization (IVF)",
