...
model.formula <- as.formula("readmitted ~ discharge + race + source + medical_specialty + 
                             time_in_hospital + age + diag_1 + A1Cresult  +  diag_1 * discharge +
                             race * discharge + medical_specialty*discharge + discharge*time_in_hospital +
                             time_in_hospital*medical_specialty + age * medical_specialty +
                             time_in_hospital*diag_1 + A1Cresult* diag_1")
```
...
```{r}
# your code here
# fit_full = glm(...., data = diabetic.data)
# summary(fit_full)
...
# obs.y2<-diabetic.data$readmitted
# pred.y2 <- predict(fit_full, type = "response")
# your code here
# ?roc
# ?auc
...
# your code here
# trCntl <- trainControl(...)
# fit_CV <- train(...., data = diabetic.data)
# fit_CV$resample
...
# your code here
# ctrl<-trainControl(...)
# fit.cv.bin<-train(..., data = diabetic.data,
#                   trControl = ctrl,
...
# your code here
# ctrl<-trainControl(...)
# fit.cv.bin<-train(model.formula0, 
#                 data = diabetic.data, 
#                 trControl = ctrl, 
#                 ....)
# fit.cv.bin
...
The 5 most important predictor categoreis are `dischargeOther`, `time_in_hopsital`, `age[60,100)`, `diag_1Respiratory` and `diag1_Musculoskeletal`.
